...
Vagrant.configure(2) do |config|
  ...
  config.vm.network 'forwarded_port', guest: 8069, host: 2345
  ...
  config.vm.synced_folder "../odoo10/OCB", "/home/vagrant/vagrant-server/"
  # config.vm.synced_folder "../odoo10/misc-addons", "/home/vagrant/vagrant-server/custom/misc-addons"
  ...
  # config.vm.synced_folder "../odoo/it-projects-llc-addons/misc-addons", "/home/vagrant/vagrant-server/custom/it-projects-llc-addons"
